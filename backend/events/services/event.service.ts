...
export class EventService {
  ...
  getEventById = async (eventId: number): Promise<EventRow | null> => {
    try {
  ...
  getAllEvents = async (): Promise<EventRow[]> => {
    try {
  ...
  getActiveEvents = async (): Promise<EventWithOrganizer[]> => {
    try {
  ...
  getEventsWithOrganizer = async (): Promise<EventWithOrganizer[]> => {
    try {
  ...
  updateAllEventStatuses = async (): Promise<number> => {
    try {
